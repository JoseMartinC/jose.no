...
export const AboutMe = () => {
  ...
  return (
    <Modal img={yo} color="blue" title="about me">
      ...
      Along with development, I love design, graphics, UX, 3D and industrial computing (my field of specialisation during my academic years at the Polytechnic University of Valencia). AI, robotics, automatons, real-time systems, will always be exciting technologies for me.<br/><br/>
